'use client';
import { Divider, Thumbnail, Typography } from '@eduplexmkt/mkt-design-system';
...
const GettingStarted = () => {
  return (
    <>
      ...
      <Heading2 content="What is Eduplex MKT Design System" />
      ...
      >
        {`에듀플렉스 마케팅 디자인 시스템 'Eduplex MKT Design System'는 영화에서 여러 장면을 조합해 새로운 초상을 만드는 몽타주 기법처럼,
