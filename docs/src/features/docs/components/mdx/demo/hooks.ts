...
import { useToast } from '@eduplexmkt/mkt-design-system';
import * as React from 'react';
import * as Wds from '@eduplexmkt/mkt-design-system';
import * as WdsIcon from '@eduplexmkt/mkt-icon';
...
export const useReactDemoRunner = ({ code }: UseReactDemoRunnerParams) => {
  ...
  const scope = useMemo(() => {
    return {
      import: {
        react: React,
        '@eduplexmkt/mkt-design-system': Wds,
        '@eduplexmkt/mkt-icon': WdsIcon,
