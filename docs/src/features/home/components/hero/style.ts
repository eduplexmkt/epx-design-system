import { css, keyframes, respondTo } from '@eduplexmkt/mkt-design-system';
...
export const titleStyle = (theme: Theme) => css`
  font-family: var(--font-family-eduplex-sans);
  font-size: 72px;
  font-style: normal;
  font-weight: 500;
  line-height: 100%;
...
export const startButtonStyle = (theme: Theme) => css`
  ...
  @media (pointer: fine) {
    &:hover {
      background-color: ${theme.semantic.accent.background.yellow};
...
export const marqueeImageStyle = (theme: Theme) => css`
  ...
  &:nth-child(10) img,
  &:nth-child(11) img {
    filter: grayscale(1) sepia(1) saturate(650%) hue-rotate(167deg)
      brightness(72%) contrast(125%);

    drop-shadow: 0 8px 18px rgba(0, 84, 167, 0.12);
  }
  ...
  &:nth-child(6) img,
  &:nth-child(9) img {
    filter: grayscale(1) sepia(1) saturate(1100%) hue-rotate(4deg)
      brightness(112%) contrast(112%);

    drop-shadow: 0 8px 18px rgba(255, 241, 0, 0.16);
  }
`;
