...
import { IconArrowTurnDownLeft, IconChevronLeft } from '@eduplexmkt/mkt-icon';
        ...
        >
          <FlexBox alignItems="center" gap="6px">
            ...
            <FlexBox
              as="a"
              alignItems="center"
              href="https://www.algolia.com/developers?utm_source=eduplex-mkt-design-system&utm_medium=referral&utm_content=powered_by&utm_campaign=docsearch"
              target="_blank"
              rel="noreferrer"
            >
              <AlgoliaLogo />
