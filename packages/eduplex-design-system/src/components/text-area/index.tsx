...
import { Box, css } from '@eduplexmkt/mkt-engine';
import { composeEventHandlers } from '@radix-ui/primitive';
import { IconCircleExclamationFill } from '@eduplexmkt/mkt-icon';
...
import type { DefaultComponentPropsInternal } from '@eduplexmkt/mkt-engine';
